  ...
  return (
    <div className="min-h-screen bg-orange-500 text-black" data-testid="landing-page">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-5 py-6 md:px-8 md:py-8" data-testid="landing-container">
        ...
        >
          <div className="w-full max-w-[340px] overflow-hidden rounded border border-black/70 bg-black/25 p-1" data-testid="landing-fixed-logo-area">
            <div className="h-[128px] w-full overflow-hidden rounded bg-[#11161f]" data-testid="landing-fixed-logo-frame">
              <img
        ...
        <section className="grid items-start gap-6 py-2 lg:grid-cols-2" data-testid="landing-hero-section">
          ...
          >
            ...
            <p className="mt-3 max-w-xl text-base font-medium" data-testid="landing-subtitle">
              Binance adapter + LIVE execution ile güvenli başlangıç. User/Admin panel, bot config, risk policy ve strategy template yönetimi ilk fazda hazır.
            </p>
            <div className="mt-5 flex flex-wrap gap-3">
              ...
              <div className="border border-black px-3 py-2 text-xs font-mono" data-testid="landing-mode-chip">Execution Mode: LIVE</div>
            </div>
