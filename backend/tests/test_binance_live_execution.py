...
from core.go_live_checklist import run_live_lifecycle_validation
from db import SessionLocal
from models import User


def test_binance_live_order_lifecycle_market_limit_cancel():
    ...
    try:
        ...
        result = None
        for _ in range(2):
            result = run_live_lifecycle_validation(db, user_id=canary_user.id, symbol="BTCUSDT", size=0.0001)
