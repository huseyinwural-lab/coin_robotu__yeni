# Learning Adaptive Engine & Lifecycle Routes - TestClient Tests
...
class TestLearningOverviewAdaptiveFields:
    ...
    def test_overview_returns_200(self, client, admin_headers):
        ...
        response = client.get("/api/admin/learning/overview", headers=admin_headers)
        assert response.status_code == 200, f"Expected 200, got {response.status_code}: {response.text}"

    def test_overview_has_schema_version(self, client, admin_headers):
    ...
    def test_overview_has_engine_version(self, client, admin_headers):
        """Overview response has engine_version"""
        response = client.get("/api/admin/learning/overview", headers=admin_headers)
        data = response.json()
        assert "engine_version" in data, "Missing engine_version"

    def test_overview_has_guardrails(self, client, admin_headers):
    ...
    def test_overview_has_strategy_memory(self, client, admin_headers):
    ...
    def test_overview_has_family_memory(self, client, admin_headers):
    ...
    def test_overview_has_recommendations(self, client, admin_headers):
    ...
    def test_overview_has_events(self, client, admin_headers):
    ...
    def test_overview_has_adaptive_summary(self, client, admin_headers):
    ...
    def test_strategy_memory_has_rolling_windows(self, client, admin_headers):
    ...
    def test_strategy_memory_has_decay_score(self, client, admin_headers):
    ...
    def test_strategy_memory_has_regime_drift_flag(self, client, admin_headers):
    ...
    def test_strategy_memory_has_drift_confidence(self, client, admin_headers):
    ...
    def test_strategy_memory_has_actionability_flag(self, client, admin_headers):
...
class TestRecommendationPayloadFields:
    ...
    def test_recommendation_has_actionable_state(self, client, admin_headers):
    ...
    def test_recommendation_has_recommendation_score(self, client, admin_headers):
    ...
    def test_recommendation_has_decision_candidate(self, client, admin_headers):
    ...
    def test_recommendation_has_auto_apply_eligible(self, client, admin_headers):
    ...
    def test_recommendation_has_scope_reason(self, client, admin_headers):
    ...
    def test_recommendation_has_cross_strategy_correlation(self, client, admin_headers):
...
class TestSimulateImpactPortfolioStyle:
    ...
    def test_simulate_impact_returns_200(self, client, admin_headers):
    ...
    def test_simulate_impact_with_strategy_ids(self, client, admin_headers):
    ...
    def test_simulate_impact_with_symbol_cluster(self, client, admin_headers):
    ...
    def test_simulate_impact_with_scenario(self, client, admin_headers):
    ...
    def test_simulate_impact_has_baseline_metrics(self, client, admin_headers):
    ...
    def test_simulate_impact_has_projected_metrics(self, client, admin_headers):
    ...
    def test_simulate_impact_has_delta_metrics(self, client, admin_headers):
    ...
    def test_simulate_impact_has_sample_coverage(self, client, admin_headers):
    ...
    def test_simulate_impact_has_portfolio_impact(self, client, admin_headers):
    ...
    def test_simulate_impact_has_interaction_effects(self, client, admin_headers):
    ...
    def test_simulate_impact_has_risk_aware_view(self, client, admin_headers):
...
class TestLearningLifecycleRoutes:
    ...
    def test_events_endpoint_returns_200(self, client, admin_headers):
        """GET /api/admin/learning/events returns 200"""
        response = client.get("/api/admin/learning/events", headers=admin_headers)
        assert response.status_code == 200, f"Expected 200, got {response.status_code}: {response.text}"
        data = response.json()
        assert "items" in data
        assert "schema_version" in data

    def test_refresh_endpoint_returns_200(self, client, admin_headers):
    ...
    def test_simulate_recommendation_returns_200_or_404(self, client, admin_headers):
        """POST /api/admin/learning/recommendations/{id}/simulate returns 200 or 404"""
        # First get a recommendation ID from overview
        overview_response = client.get("/api/admin/learning/overview", headers=admin_headers)
        ...
        response = client.post(
            f"/api/admin/learning/recommendations/{rec_id}/simulate",
            headers=admin_headers,
        )
        assert response.status_code in [200, 404], f"Expected 200 or 404, got {response.status_code}"

    def test_approve_recommendation_returns_200_or_404(self, client, admin_headers):
        ...
        rec_id = recommendations[0]["id"]
        response = client.post(
            f"/api/admin/learning/recommendations/{rec_id}/approve",
            headers=admin_headers,
    ...
    def test_reject_recommendation_returns_200_or_404(self, client, admin_headers):
        ...
        rec_id = recommendations[0]["id"]
        response = client.post(
            f"/api/admin/learning/recommendations/{rec_id}/reject",
            headers=admin_headers,
            json={"reason": "test rejection reason"},
        )
        assert response.status_code in [200, 400, 404], f"Expected 200/400/404, got {response.status_code}"

    def test_version_history_returns_200_or_404(self, client, admin_headers):
        ...
        rec_id = recommendations[0]["id"]
        response = client.get(
            f"/api/admin/learning/recommendations/{rec_id}/version-history",
            headers=admin_headers,
        )
        assert response.status_code in [200, 404], f"Expected 200 or 404, got {response.status_code}"
        if response.status_code == 200:
    ...
    def test_post_change_monitoring_returns_200_or_404(self, client, admin_headers):
        ...
        rec_id = recommendations[0]["id"]
        response = client.get(
            f"/api/admin/learning/recommendations/{rec_id}/post-change-monitoring",
            headers=admin_headers,
        )
        assert response.status_code in [200, 404], f"Expected 200 or 404, got {response.status_code}"
        if response.status_code == 200:
    ...
    def test_apply_recommendation_returns_200_or_error(self, client, admin_headers):
        ...
        rec_id = recommendations[0]["id"]
        response = client.post(
            f"/api/admin/learning/recommendations/{rec_id}/apply",
            headers=admin_headers,
    ...
    def test_rollback_recommendation_returns_200_or_error(self, client, admin_headers):
        ...
        rec_id = recommendations[0]["id"]
        response = client.post(
            f"/api/admin/learning/recommendations/{rec_id}/rollback",
            headers=admin_headers,
...
class TestNoRegressions:
    ...
    def test_overview_contract_stable(self, client, admin_headers):
    ...
    def test_simulate_impact_contract_stable(self, client, admin_headers):
    ...
    def test_events_contract_stable(self, client, admin_headers):
    ...
    def test_user_suggestions_endpoint_exists(self, client, admin_headers):
        """GET /api/admin/learning/user-suggestions returns 200"""
        response = client.get("/api/admin/learning/user-suggestions", headers=admin_headers)
        assert response.status_code == 200, f"Expected 200, got {response.status_code}: {response.text}"
        data = response.json()
