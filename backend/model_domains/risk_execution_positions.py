...
class RiskOrchestratorApprovalRequest(Base):
    ...
    priority: Mapped[str] = mapped_column(String(20), default="SAFE", index=True)
    ...
    warning_escalated_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    critical_escalated_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    expired_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    escalation_count: Mapped[int] = mapped_column(Integer, default=0)
    force_applied: Mapped[bool] = mapped_column(Boolean, default=False)
...
class RiskPolicy(Base):
    ...
    status_reason: Mapped[str | None] = mapped_column(String(280), nullable=True)
