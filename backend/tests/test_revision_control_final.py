...
def get_auth_token():
    """Get super_admin authentication token (cached)"""
...
class TestRevisionControlEndpoints:
    ...
    def setup(self):
        """Setup for each test - ensure we have valid headers"""
    ...
    def test_auth_works(self):
        ...
        assert self.headers is not None, "Failed to get auth token"
    ...
    def test_create_strategy_returns_revision_id(self):
        ...
        response = create_test_strategy(self.headers, strategy_id)
    ...
    def test_update_with_correct_revision_succeeds(self):
        ...
        create_resp = create_test_strategy(self.headers, strategy_id)
        ...
        # Cleanup
        delete_test_strategy(self.headers, strategy_id, updated["revision_id"])
