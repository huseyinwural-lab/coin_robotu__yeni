# P1 Execution Microstructure API Tests
...
class TestP1GuardPreviewSlippageDecomposition:
    ...
    def test_guard_preview_returns_slippage_decomposition(self, auth_headers):
    ...
    def test_guard_preview_slippage_prediction_consistency(self, auth_headers):
...
class TestP1MarketRegimeAndExecutionRecommendation:
    ...
    def test_guard_preview_returns_market_regime(self, auth_headers):
    ...
    def test_guard_preview_returns_execution_recommendation(self, auth_headers):
...
class TestP1VenueHealthAndLiquidityStress:
    ...
    def test_venues_endpoint_returns_health_scores(self, auth_headers):
    ...
    def test_venues_endpoint_symbol_level_health(self, auth_headers):
    ...
    def test_guard_preview_returns_venue_health(self, auth_headers):
...
class TestP1MicrostructureReplay:
    ...
    def test_replay_endpoint_returns_items(self, auth_headers):
    ...
    def test_replay_endpoint_filters_by_symbol(self, auth_headers):
    ...
    def test_replay_endpoint_filters_by_venue(self, auth_headers):
    ...
    def test_replay_item_structure(self, auth_headers):
...
class TestP1ExecutionReplayLatest:
    ...
    def test_execution_replay_latest_endpoint_exists(self, auth_headers):
    ...
    def test_execution_replay_latest_empty_state(self, auth_headers):
...
class TestP0RegressionNoBreakingChanges:
    ...
    def test_microstructure_status_endpoint(self, auth_headers):
    ...
    def test_microstructure_venues_endpoint(self, auth_headers):
    ...
    def test_guard_preview_state_field(self, auth_headers):
    ...
    def test_guard_preview_market_snapshot_structure(self, auth_headers):
...
class TestBybitVenueGracefulHandling:
    ...
    def test_bybit_venue_in_venues_response(self, auth_headers):
    ...
    def test_guard_preview_with_bybit_venue(self, auth_headers):
