"""
P2 Policy UX Tooling E2E Tests - Using TestClient
...
class TestPolicyBuilder:
    ...
    def test_policy_validate_success(self, auth_headers):
        ...
        response = client.post("/api/admin/execution-policies/validate", json=payload, headers=auth_headers)
    ...
    def test_policy_validate_errors_block(self, auth_headers):
    ...
    def test_policy_validate_high_risk_warning(self, auth_headers):
    ...
    def test_policy_create_version(self, auth_headers):
        ...
        response = client.post("/api/admin/execution-policies/builder/versions", json=payload, headers=auth_headers)
...
class TestActivationGate:
    ...
    def test_activation_blocked_with_errors(self, auth_headers):
        ...
        create_response = client.post("/api/admin/execution-policies/builder/versions", json=create_payload, headers=auth_headers)
        ...
        response = client.post(f"/api/admin/execution-policies/versions/{version_id}/activate", json=activate_payload, headers=auth_headers)
    ...
    def test_high_risk_override_required(self, auth_headers):
    ...
    def test_prod_approval_gate(self, auth_headers):
...
class TestDiffViewer:
    ...
    def test_diff_comparison(self, auth_headers):
        ...
        # Create version A
        response_a = client.post("/api/admin/execution-policies/builder/versions", json=base_payload, headers=auth_headers)
        ...
        response_b = client.post("/api/admin/execution-policies/builder/versions", json=base_payload, headers=auth_headers)
        ...
        response = client.post("/api/admin/execution-policies/diff", json=diff_payload, headers=auth_headers)
...
class TestSimulationPanel:
    ...
    def test_simulation_single_intent(self, auth_headers):
        ...
        response = client.post("/api/admin/execution-policies/simulate", json=sim_payload, headers=auth_headers)
    ...
    def test_simulation_no_trigger(self, auth_headers):
        """Simulate policy with values below thresholds"""
        # Get existing versions
        response = client.get("/api/admin/execution-policies", headers=auth_headers)
...
class TestBulkOperations:
    ...
    def test_bulk_activate(self, auth_headers):
        ...
        for i in range(2):
            ...
            response = client.post("/api/admin/execution-policies/builder/versions", json=create_payload, headers=auth_headers)
            if response.status_code == 200:
        ...
        response = client.post("/api/admin/execution-policies/bulk/activate", json=bulk_payload, headers=auth_headers)
    ...
    def test_bulk_rollback(self, auth_headers):
        ...
        response = client.post("/api/admin/execution-policies/bulk/rollback", json=bulk_payload, headers=auth_headers)
    ...
    def test_bulk_strategy_binding(self, auth_headers):
        ...
        response = client.post("/api/admin/execution-policies/bulk/strategy-binding", json=bulk_payload, headers=auth_headers)
...
class TestAuditLog:
    ...
    def test_audit_timeline_endpoint(self, auth_headers):
        """Test audit timeline endpoint"""
        response = client.get("/api/venues/admin/audit-timeline", headers=auth_headers)
        # This endpoint may or may not exist
        if response.status_code == 404:
            # Try alternative audit endpoints
            response = client.get("/api/admin/audit-logs?limit=10", headers=auth_headers)
        
        if response.status_code == 404:
            # Try another alternative
            response = client.get("/api/admin/system/audit-logs?limit=10", headers=auth_headers)
    ...
    def test_policy_actions_create_audit(self, auth_headers):
        ...
        response = client.post("/api/admin/execution-policies/validate", json=validate_payload, headers=auth_headers)
        assert response.status_code == 200
...
class TestJSONReadOnly:
    ...
    def test_execution_policies_json_structure(self, auth_headers):
    ...
    def test_policy_version_json_readonly(self, auth_headers):
...
class TestVersionValidation:
    ...
    def test_version_validate_endpoint(self, auth_headers):
        ...
        response = client.post(f"/api/admin/execution-policies/versions/{version_id}/validate", headers=auth_headers)
