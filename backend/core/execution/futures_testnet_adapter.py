...
from services.live_mode_service import BinanceFuturesTestnetAdapter


class FuturesTestnetAdapter:
    def __init__(self, adapter: BinanceFuturesTestnetAdapter | None = None):
        self.adapter = adapter or BinanceFuturesTestnetAdapter()
