...
def run_futures_paper_decision_flow(
    *,
    ...
    decision_trace = build_decision_trace(
        ...
        strategy_type=str(signal.get("strategy_type") or strategy_id),
        strategy_signal_strength=float(signal.get("strategy_signal_strength") or signal.get("confidence") or 0.0),
