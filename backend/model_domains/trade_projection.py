...
class UserTradeProjection(Base):
    ...
    strategy_version_id: Mapped[str | None] = mapped_column(String(120), nullable=True, index=True)
    scan_run_id: Mapped[str | None] = mapped_column(String(120), nullable=True, index=True)
    signal_id: Mapped[str | None] = mapped_column(String(120), nullable=True, index=True)
    decision_card_id: Mapped[str | None] = mapped_column(String(120), nullable=True, index=True)
